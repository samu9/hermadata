...
Revision ID: 84a80d7f96cb
Revises: 
Create Date: 2023-11-19 10:54:27.330767
...
def upgrade() -> None:
    ...
    op.create_table('procedure_kind',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=50), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['kind_id'], ['document_kind.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['kind_id'], ['procedure_kind.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('procedure_document',
    sa.Column('procedure_kind_id', sa.Integer(), nullable=False),
    sa.Column('document_kind_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['document_kind_id'], ['document_kind.id'], ),
    sa.ForeignKeyConstraint(['procedure_kind_id'], ['procedure_kind.id'], ),
    ...
    op.create_table('procedure_document_checklist',
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['animal_id'], ['animal.id'], ),
    sa.ForeignKeyConstraint(['vet_id'], ['animal.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
