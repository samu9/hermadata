...
Revision ID: 7bfc4704040d
Revises: 1bb12e9dcab1
Create Date: 2024-04-21 10:46:46.058642
...
def upgrade() -> None:
    ...
    sa.Column('chip_code_set', sa.Boolean(), server_default=sa.text('false'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['adopter_id'], ['adopter.id'], ),
    sa.ForeignKeyConstraint(['animal_id'], ['animal.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('animal_document',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('animal_id', sa.Integer(), nullable=False),
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.Column('document_kind_id', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['animal_id'], ['animal.id'], ),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('animal_id', 'document_id', 'document_kind_id', name='unique_animal_document')
    )
    op.create_table('animal_entry',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('animal_id', sa.Integer(), nullable=False),
