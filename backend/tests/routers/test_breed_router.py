...
def test_get_all_breeds(mock_dep, test_client, mock_breed_repository):
...
@patch('hermadata.routers.breed_router.breed_repository')
def test_get_all_breeds_missing_race_id(mock_dep, test_client, mock_breed_repository):
...
@patch('hermadata.routers.breed_router.breed_repository')
def test_create_breed_success(mock_dep, test_client, mock_breed_repository):
...
@patch('hermadata.routers.breed_router.breed_repository')
def test_create_breed_integrity_error(mock_dep, test_client, mock_breed_repository):
...
@patch('hermadata.routers.breed_router.breed_repository')
def test_create_breed_invalid_data(mock_dep, test_client, mock_breed_repository):
