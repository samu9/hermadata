...
def test_new_animal_adoption_success(mock_repo_class, test_client):
...
@patch('hermadata.routers.adoption_router.SQLAdopionRepository')
def test_new_animal_adoption_existing_adoption(mock_repo_class, test_client):
...
@patch('hermadata.routers.adoption_router.SQLAdopionRepository')
def test_new_animal_adoption_invalid_data(mock_repo_class, test_client):
