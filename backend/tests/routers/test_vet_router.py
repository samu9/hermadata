...
class TestVetRouter:
    """Test cases for vet router endpoints"""
    
    @patch('hermadata.routers.vet_router.vet_repository')
    def test_create_vet(self, mock_dep, test_client, mock_vet_repository):
    ...
    @patch('hermadata.routers.vet_router.vet_repository')
    def test_search_vet(self, mock_dep, test_client, mock_vet_repository):
    ...
    @patch('hermadata.routers.vet_router.vet_repository')
    def test_search_vet_with_params(self, mock_dep, test_client, mock_vet_repository):
