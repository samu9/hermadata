...
class TestUtilRouter:
    """Test cases for utility router endpoints"""
    
    @patch('hermadata.routers.util_router.city_repository')
    def test_get_province(self, mock_dep, test_client, mock_city_repository):
    ...
    @patch('hermadata.routers.util_router.city_repository')
    def test_get_comuni(self, mock_dep, test_client, mock_city_repository):
    ...
    def test_get_entry_types(self, test_client):
    ...
    def test_get_exit_types(self, test_client):
    ...
    def test_get_animal_sizes(self, test_client):
    ...
    def test_get_animal_fur_types(self, test_client):
    ...
    def test_get_animal_stages(self, test_client):
    ...
    def test_get_animal_fur_colors(self, mock_dep, test_client, mock_animal_repository):
    ...
    @patch('hermadata.routers.util_router.animal_repository')
    def test_add_fur_color(self, mock_dep, test_client, mock_animal_repository):
    ...
    @patch('hermadata.routers.util_router.animal_repository') 
    def test_add_fur_color_invalid_name(self, mock_dep, test_client, mock_animal_repository):
    ...
    def test_get_comuni_missing_parameter(self, test_client):
