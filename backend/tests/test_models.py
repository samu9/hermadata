...
class TestIntToSex:
    """Test cases for int_to_sex function"""
    
    def test_int_to_sex_male(self):
        """Test converting 0 to 'M' for male"""
        result = int_to_sex(0)
        assert result == "M"
    
    def test_int_to_sex_female(self):
        """Test converting 1 to 'F' for female"""
        result = int_to_sex(1)
        assert result == "F"
    
    def test_int_to_sex_string_passthrough(self):
    ...
    def test_int_to_sex_invalid_int(self):
...
class TestPaginationQuery:
    """Test cases for PaginationQuery model"""
    ...
    def test_pagination_query_with_values(self):
...
class TestSearchQuery:
    ...
    def test_search_query_inherits_pagination(self):
...
class TestPaginationResult:
    """Test cases for PaginationResult model"""
    
    def test_pagination_result_empty(self):
        """Test PaginationResult with empty items"""
        result = PaginationResult[str](total=0)
        assert result.total == 0
        assert result.items == []
    
    def test_pagination_result_with_items(self):
...
class TestUtilElement:
    """Test cases for UtilElement model"""
    
    def test_util_element_string_id(self):
    ...
    def test_util_element_int_id(self):
