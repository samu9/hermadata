...
class TestApiErrorExceptionHandler:
    """Test cases for API error exception handler"""
    
    @pytest.mark.asyncio
    async def test_handle_animal_without_chip_code_exception(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_entry_not_complete_exception(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_no_required_exit_data_exception(self):
    ...
    @pytest.mark.asyncio
    async def test_handle_unknown_exception(self):
    ...
    def test_error_messages_coverage(self):
    ...
    def test_default_message_exists(self):
